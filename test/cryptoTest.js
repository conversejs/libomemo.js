...
describe("Crypto", function () {
    ...
    function testCurve25519() {
        ...
        const alice_priv = hexToArrayBuffer(
            "70076d0a7318a57d3c16c17251b26645df4c2f87ebc0992ab177fba51db92c6a"
        );
        const alice_pub = hexToArrayBuffer(
            "058520f0098930a754748b7ddcb43ef75a0dbf3a0d26381af4eba4a98eaa9b4e6a"
        );
        const bob_bytes = hexToArrayBuffer(
            "5dab087e624a8a4b79e17f8b83800ee66f3bb1292618b6fd1c2f8b27ff88e0eb"
        );
        const bob_priv = hexToArrayBuffer(
            "58ab087e624a8a4b79e17f8b83800ee66f3bb1292618b6fd1c2f8b27ff88e06b"
        );
        const bob_pub = hexToArrayBuffer(
            "05de9edb7d7b7dc1b4d35b61c2ece435373f8343c85b78674dadfc7e146f882b4f"
        );
        const shared_sec = hexToArrayBuffer(
        ...
        const priv = hexToArrayBuffer(
            "48a8892cc4e49124b7b57d94fa15becfce071830d6449004685e387c62409973"
        );
        const pub = hexToArrayBuffer(
            "0555f1bfede27b6a03e0dd389478ffb01462e5c52dbbac32cf870f00af1ed9af3a"
        );
