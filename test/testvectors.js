...
const TestVectors = (function () {
    ...
    const TwoPartyTestVectorsAlice = [
        [
            ...
            {
                smsText: "A",
                ourBaseKey: hexToArrayBuffer(
                    "2060fe31b041d28127ac35cbfe790e2a25f92d2e21eb2251690ae75e732f5c4d"
                ),
                ourEphemeralKey: hexToArrayBuffer(
                    "082e6391deb7154bd0375df3fc07f87020a3b0fd7a8c6c90e73f0e054bc2bf5d"
                ),
                ourIdentityKey: hexToArrayBuffer(
                    "d83d8141aad5f1d62d78a1af09ffbe61f2d3458eeb887a047a58a07565d24463"
                ),
                registrationId: 10290,
                getKeys: {
                    identityKey: hexToArrayBuffer(
                        "059c2197be51bae703ae2edd26b6ff2b03d589ef4851be33a3f8d923ad86a6b439"
                    ),
                    devices: [
                        {
                            deviceId: 1,
                ...
                expectedCiphertext: hexToUint8Array(
        ...
        [
            "receiveMessage",
            {
                ...
                newEphemeralKey: hexToArrayBuffer(
                    "d04f334799ea1272eff64c5267e28274f54b91b3b11372879303eb7a8cd52763"
                ),
                expectedSmsText: "C",
            },
        ],
    ...
    tests[tests.length] = {
        name: "Standard Signal Protocol Test Vectors as Alice",
    ...
    const TwoPartyTestVectorsBob = [
        [
            "receiveMessage",
            {
                ...
                ourPreKey: hexToArrayBuffer(
                    "88d9a12e7b03afdac42e49ec9d4e5488e1b1e6d48c6eef6029e45dec09a9d562"
                ),
                preKeyId: 4611143,
                ourSignedPreKey: hexToArrayBuffer(
                    "888b3f14aff80e36bb2d2cc26a72da2e1a99330962f5066c7c1dded1262ca665"
                ),
                signedPreKeyId: 14983230,
                ourIdentityKey: hexToArrayBuffer(
                    "58c9fb2ec2c6b13e279e7db57ce837c02aac1531504f71130d167cc8fb25a857"
                ),
                newEphemeralKey: hexToArrayBuffer(
                    "f0b66ac79b6f4ae997636bc8ed622a184dbe00603b2c657ac18800122523d142"
                ),
                expectedSmsText: "A",
            },
        ],
        ...
        [
            "receiveMessage",
            {
                ...
                type: 1,
                newEphemeralKey: hexToArrayBuffer(
                    "98bee5f861b528816888d45c2ca40125b111d2c03e483e57e6886c82dd758467"
                ),
                expectedSmsText: "E",
            },
        ],
    ...
    tests[tests.length] = {
        name: "Standard Signal Protocol Test Vectors as Bob",
    ...
    tests[tests.length] = (function () {
        ...
        v[0][1] = {
            message: orig[1][1].message,
            type: orig[1][1].type,
            expectedSmsText: orig[1][1].expectedSmsText,
        };
        ...
        v[1][1] = {
            message: orig[0][1].message,
            type: orig[0][1].type,
            expectedSmsText: orig[0][1].expectedSmsText,
        };
    ...
    const EndSessionTestVectorsBob = [
        [
            "receiveMessage",
            {
                ...
                type: 3,
                ourPreKey: hexToArrayBuffer(
                    "f8ed827e88146a95061863870454eca91e01531762caeeba2e09d107a8987875"
                ),
                preKeyId: 3850073,
                ourSignedPreKey: hexToArrayBuffer(
                    "887ebaa951738423384ca0f0d1ebc14dcf196413512b4840ddbe56cbea272a50"
                ),
                signedPreKeyId: 10476053,
                ourIdentityKey: hexToArrayBuffer(
                    "d8cb8fcc1c186b7019126a0d07054f9b9a48ed69771c549937b22092dc18b875"
                ),
                newEphemeralKey: hexToArrayBuffer(
                    "c89599f0d89eefd371418e9112a41ce43b7eec9e4b7b920c945388d1371e624f"
                ),
                expectedSmsText: "A",
            },
        ],
        ...
        [
            "receiveMessage",
            {
                ...
                type: 3,
                ourPreKey: hexToArrayBuffer(
                    "d04cad1fd6c9a73b3a6ef89f45941d60f87cefc0efe1fca95befd49494a80673"
                ),
                preKeyId: 3850074,
                ourSignedPreKey: hexToArrayBuffer(
                    "887ebaa951738423384ca0f0d1ebc14dcf196413512b4840ddbe56cbea272a50"
                ...
                newEphemeralKey: hexToArrayBuffer(
                    "b0c7452e8d971a4c8e032e019f0584876cd2a0ef58029cea034baa625cb04d53"
                ),
                expectedSmsText: "C",
            },
        ],
    ...
    const EndSessionTestVectorsAlice = [
        [
            "sendMessage",
            {
                smsText: "A",
                ourBaseKey: hexToArrayBuffer(
                    "f09e0e39eb96b08d952c0c3f8283260e6de0575ea22e9b52a1c941eb28981b4a"
                ),
                ourEphemeralKey: hexToArrayBuffer(
                    "38480c56ce72a9aaae59ec082818c6b79d0eb2454d6e79427d5626e37ca7f057"
                ),
                ourIdentityKey: hexToArrayBuffer(
                    "88fd1a1d2d30f85a29504fd12e3012bc5e4bd0e87487103c5eaa02ea69993050"
                ),
                registrationId: 4620,
                getKeys: {
                    identityKey: hexToArrayBuffer(
                        "0503086f4fbae45fdfbcc3e9cc39e5851183b89ccc15e9216b9fda5ab5ce2adf35"
                    ),
                    devices: [
                        {
                            deviceId: 1,
        ...
        [
            "sendMessage",
            {
                smsText: "C",
                ourBaseKey: hexToArrayBuffer(
                    "20174d12685909b9bf1e83ce8edecab2858a2d50cb5b08d163fba2b463a1c768"
                ),
                ourEphemeralKey: hexToArrayBuffer(
                    "90c06b979a12a0055411ef6d4a7a80e8297aaec037b2fd4f8e8b7a0d3c0aa268"
                ),
                ourIdentityKey: hexToArrayBuffer(
                    "88fd1a1d2d30f85a29504fd12e3012bc5e4bd0e87487103c5eaa02ea69993050"
                ),
        ...
        [
            "receiveMessage",
            {
                ...
                type: 1,
                newEphemeralKey: hexToArrayBuffer(
                    "58ea057d9f33be4312a5581e223c277363e3b13c6db1920f63dab8fe29073775"
                ),
                expectedSmsText: "E",
            },
        ],
